...
export const translations = {
  en: {
    ...
    pin_locked: "Piece #{id} pinned - REPACK will now work around it.",
    pin_unlocked: "Piece #{id} unpinned.",
    drag_placed: "Piece #{id} moved and pinned.",
    drag_rejected: "Won't fit there - it would overlap another piece or cross the sheet edge (spacing and margin count).",
    drag_failed: "Could not check that position: {err}",
    drag_hint: "Drag a piece to move it, click a piece to pin it. REPACK tidies the unpinned pieces around the pinned ones.",
  ...
  vi: {
    ...
    pin_locked: "Đã ghăm chi tiết #{id} - XẾP LẠI sẽ sắp xếp xung quanh nó.",
    pin_unlocked: "Đã bỏ ghăm chi tiết #{id}.",
    drag_placed: "Đã di chuyển và ghăm chi tiết #{id}.",
    drag_rejected: "Không vừa ở đó - sẽ chồng lên chi tiết khác hoặc vượt mép tấm (tính cả khoảng cách và lề).",
    drag_failed: "Không kiểm tra được vị trí đó: {err}",
    drag_hint: "Kéo để di chuyển chi tiết, bấm để ghăm. XẾP LẠI sẽ sắp xếp các chi tiết chưa ghăm xung quanh các chi tiết đã ghăm.",
